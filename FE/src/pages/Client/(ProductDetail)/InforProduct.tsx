        ...
        <div className="h-full w-full *:w-full lg:mt-2 mb:mt-5">
            <div className="flex flex-col lg:gap-y-2">
                ...
                <div className="lg:pb-5 flex flex-col lg:gap-y-2">
                    <span className="text-gray-700 font-bold lg:text-base mb:text-sm">Loai san pham demo</span>
                    <strong className="lg:text-2xl lg:mt-0 mb:mt-3.5 mb:text-xl lg:tracking-[-1.2px] font-medium lg:leading-[38.4px]">Ten san pham demo</strong>
                ...
                <div className="flex flex-col gap-y-1 lg:mt-[2px] mt-[3px] lg:pb-0 mb:pb-[21px] font-medium">
                    <span className="text-sm lg:text-base tracking-[1px]">Mô tả ngắn</span>
                    <p className="text-sm lg:text-base text-gray-600">Ahihi day la mo ta ngan cua san pham demo ahihihihihihihihihihih</p>
                </div>
                {/* row 3 */}
                <div>
                    <span className="text-lg lg:mt-[1px] mb:mt-3.5 lg:tracking-[-1.2px] font-medium lg:leading-[38.4px]">Size</span>
                 ...
                 {/* row 4 */}
                 <div>
                    <span className="text-lg lg:mt-[1px] mb:mt-3.5 lg:tracking-[-1.2px] font-medium lg:leading-[38.4px]">Color</span>
                ...
                <div className="py-5 *:w-full rounded-xl lg:-mt-5 -mt-1">
                    ...
                    <div className="py-5 flex lg:flex-row mb:flex-col lg:gap-y-0 gap-y-[17px] gap-x-8 lg:items-center mb:items-start">
                        ...
                        <div className="border lg:py-2.5 lg:pr-6  mb:py-1 mb:pl-2 mb:pr-[18px] *:text-xs flex items-center gap-x-3 rounded-xl">
                            ...
                            <span className="text-gray-800 lg:tracking-[0.5px] border-l pl-4 border-black">Còn lại 100 sản phẩm</span>
                        </div>
