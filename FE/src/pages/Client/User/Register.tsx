        ...
        <div className="flex items-center justify-center w-full ">
          <div className="flex items-center xl:p-7">
            <form
              ...
              className="flex flex-col w-full h-full p-6 text-center bg-white border shadow-lg rounded-3xl"
            >
              ...
              <div className="mb-3">
                <label
                  htmlFor="userName"
                  className="flex mb-2 text-sm font-semibold text-gray-900 "
                >
                  UserName
                </label>
                <input
                ...
                />
                {errors.userName && (
                  <p className="mt-4 text-red-400 text-start">
