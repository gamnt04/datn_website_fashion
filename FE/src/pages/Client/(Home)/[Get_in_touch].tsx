...
const Get_in_touch = () => {
  return (<>
    <div className="container mx-auto py-16 border-b text-center">
      <h2 className="xl:text-[48px] text-2xl font-normal pb-[15px]">Get in touch</h2>
      <p className="xl:text-[18px] text-sm text-[#ABABAB] pb-[30px]">
