        ...
        <div className="">
          <div className="pt-[20px]">
            <div className="item_blog border  ">
              <div className="wrapper-image max-w-[400px] max-h-[250px] ">
                <img
              ...
              <div className="max-w-[350px] mx-auto pb-[15px]">
                <h2 className="py-[10px]">
                  <a href="" className="text-[20px] font-semibold ">
                    Urna pretium elit mauris cursus
                  </a>
                </h2>
                <div className="flex text-[#7D7D7D] text-[14px] ">
                  <p className=" ">August 29, 2023</p>
                  <p className="px-[20px]">Rubik Theme</p>
                </div>
                <div className="text-[#7D7D7D] py-[10px]">
                  <p className="text-[14px]">
                    ...
                    Lorem condimentum ornare. Mi vitae magnis Fusce laoreet nibh
                    felis porttitor...
                  </p>
                </div>
              </div>
