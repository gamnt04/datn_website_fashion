                  ...
                  <div className="">
                    <div className="flex py-[12px] w-full">
                      ...
                      <div className="flex w-[15%] justify-end items-center ">
                        <span className="">₫45.000</span>
                      </div>
                    </div>
                    <div className="py-[20px] flex justify-end items-center border-t-2 border-[#eaeaea] bg-[#FFFBF8] ">
                      <div className="flex">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                        ...
                        <span className="px-[5px]"> Số tiền hoàn lại :</span>
                      </div>
