        ...
        <div className="flex space-x-5">
          ...
          <div className="w-[81%] bg-[#F5F5F5]">
            ...
            <div className="pt-[20px] flex ">
              <div className="w-[5%]  bg-[#eaeaea] flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <input
                ...
                name=""
                id=""
                placeholder="Bạn có thể tìm kiếm ID đơn hàng hoặc Tên Sản phẩm"
                className="bg-[#eaeaea] text-[#BBBBBB] pl-[20px] w-[95%] h-[43px]"
              />
            </div>
            <div className="">
                  ...
                  <div className="">
                    <div className="flex py-[12px] w-full">
                      ...
                      <div className="flex w-[15%] justify-end items-center ">
                        ...
                        <span className="text-[#F68E56]">₫45.000</span>
                      </div>
                    </div>
                    <div className="py-[20px] flex justify-end items-center border-t-2 border-[#eaeaea] ">
                      <div className="flex">
                    ...
                    <div className="flex w-full pb-[24px]">
                      ...
                      <div className="w-[60%] flex justify-end space-x-[10px]">
                        ...
                        <button className="btn ">Xem Chi Tiết Hủy Đơn</button>
                        <button className="btn">Liên Hệ Người Bán</button>
                      </div>
                    </div>
                  </div>
                ...
                <div className="px-[24px] py-[12px] ">
                  ...
                  <div className="">
                    ...
                    <div className="flex w-full pb-[24px]">
                      ...
                      <div className="w-[60%] flex justify-end space-x-[10px]">
                        <button className="btn_recevi bg-[#f68e56] text-white">
                          Đánh Giá
                        </button>
                        <button className="btn ">Liên Hệ Người Bán</button>
                        <button className="btn">Mua Lại</button>
                      </div>
                    </div>
                  </div>
                </div>
