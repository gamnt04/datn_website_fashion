              ...
              <ul className="mb-12 *:my-4">
                <li>
                  <a
                    ...
                    className="flex justify-center lg:flex lg:justify-start lg:gap-4 *:text-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  {isOpen && (
                    <ul className="pt-2">
                      <li>
                        <NavLink
                          to={`/allorder`}
                          className="flex justify-center lg:justify-start lg:ml-10 text-sm text-center text-[#7D7D7D] py-1"
                        >
                          Hồ sơ
                        </NavLink>
                      </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <p className="hidden lg:block" onClick={() => mutate()}>
                      Đăng xuất
                    </p>
                  </a>
                </li>
