...
const Form_Item = ({ mode }: any) => {
    ...
    return (
        <div className="bg-[#21222D] relative p-4 text-gray-100 min-h-[90vh]">
            {
                (isPending || loading) && (
            ...
            <div className="flex items-center justify-between mb-5">
                <h1 className="text-2xl font-semibold">{mode ? 'Cập nhật sản phẩm' : 'Thêm sản phẩm'}</h1>
            ...
            >
                <div className="grid grid-cols-[auto,300px] gap-8">
                    <div>
                        <label htmlFor="" className=" text-gray-100 font-medium text-sm">Tên sản phẩm</label>
                        <Form.Item<FieldType>
                            name="name_product"
                            rules={[
                        ...
                        <label htmlFor="" className="text-gray-100 font-medium text-sm">Mô tả sản phẩm</label>
                        <Form.Item<FieldType>
                            name="description_product"
                        >
                            <TextArea className="!bg-[#171821] mt-2 py-2 max-w-[200px] !text-gray-100 border-gray-600 !outline-none hover:bg-[#171821] focus:bg-[#171821] active:bg-[#171821]" rows={4} />
                        </Form.Item>

                        <Form.List name="attributes" initialValue={data_one_item?.data?.product?.attributes?.values}>
                            {(fields, { add, remove }) => {
                                fields.length > 0 ? setStatus_Attr(false) : setStatus_Attr(true)
                                return (
                                    <>
                                        <label htmlFor="" className="text-gray-100 font-medium text-sm">Options sản phẩm</label>
                                        {fields.map(({ key, name, ...restField }) => (
                                            <div key={key}>
                                                <label htmlFor="" className="text-gray-100 font-medium text-sm">Màu :</label>
                                                <Form.Item
                                                    {...restField}
                                                    name={[name, "color"]}
                                                    rules={[
                                                        ...
                                                        <>
                                                            {sizeFields.map(
                                                                ({
                                                                    ...
                                                                    >
                                                                        <div>
                                                                            <label htmlFor="" className="text-gray-100 font-medium text-sm">Kích cỡ :</label>
                                                                            <Form.Item
                                                                                {...restSizeField}
                                                                        ...
                                                                        <div>
                                                                            <label htmlFor="" className="text-gray-100 font-medium text-sm">Số lượng :</label>
                                                                            <Form.Item
                                                                                {...restSizeField}
                                                                            ...
                                                                            >
                                                                                <Input
                                                                                    className="w-[183px] !bg-[#171821] mt-2 py-2 max-w-[200px] !text-gray-100 border-gray-600 !outline-none hover:bg-[#171821] focus:bg-[#171821] active:bg-[#171821]"
                                                                                />
                                                                            </Form.Item>
                                                                        </div>
                                                                        ...
                                                                        <div>
                                                                            <label htmlFor="" className="text-gray-100 font-medium text-sm">Giá :</label> <br />
                                                                            <Form.Item
                                                                                {...restSizeField}
                                                            ...
                                                            <div className="flex gap-3">
                                                                <Button onClick={() => remove(name)} className="mt-1 bg-red-600 my-4 text-gray-100 border-none hover:!bg-red-700 hover:!text-gray-100">
                                                                    Xóa options
                                                                </Button>
                                                            </div>
                                                        </>
                                        ...
                                        <Form.Item>
                                            <button type='button' className="max-w-[200px] py-2 px-3 bg-[#1677FF] hover:bg-[#4096FF] text-white text-gray-100 duration-200 rounded" onClick={() => add()}>
                                                Thêm options
                                            </button>
                                        </Form.Item>
                                    </>
                        ...
                        <Form.Item<FieldType> name="tag_product">
                            <label htmlFor="" className="text-gray-100 font-medium text-sm">Tags sản phẩm</label>
                            <div>
                                <Select
                                    mode="tags"
                                    notFoundContent="Không tìm thấy tags"
                                    allowClear
                                    className="*:!bg-[#171821] mt-2 *:py-2 max-w-[200px] *:!text-gray-100 border-gray-600 !outline-none hover:bg-[#171821] focus:bg-[#171821] active:bg-[#171821]"
                                />
                            </div>
                        ...
                        >
                            <Checkbox className="text-gray-100">Sản phẩm nổi bật</Checkbox>
                        </Form.Item>
                    </div>
                    <div>
                        <label htmlFor="" className="text-gray-100 font-medium text-sm">Danh mục</label>
                        <Form.Item
                            className="mt-2"
                            name="category_id"
                            rules={[
                ...
                {
                    isError && <span className="text-red-500">Lỗi! Vui lòng kiểm tra và thử lại!</span>
                }
                <Form.Item>
                    {
                        mode ? <Button className="bg-yellow-600 hover:!bg-yellow-700 border-none text-gray-100 hover:!text-gray-100 mt-2" htmlType="submit">
                            {
