...
//         { path: "attributeId", model: "Attributes" }
//       ]
//     });
...
//     const productExists = favoriteProducts.products.some((product) => {
//       const sameProduct = product.productId?.toString() === productId;
//       const sameAttribute = product.attributeId
//         ? product.attributeId.toString() === attributeId
//         : !attributeId;
//       return sameProduct && sameAttribute;
//     });
...
//     favoriteProducts.products.push({
//       productId,
//       attributeId
//     });
